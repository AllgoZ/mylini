  ...
  return (
    <div className="w-full mt-6 px-4 md:px-7">
      <motion.div
        ...
        className="rounded-[28px] overflow-hidden bg-gradient-to-br from-[#3D1A0A] via-[#7A3520] to-[#E8927A] p-0 grid grid-cols-1 md:grid-cols-[1fr_1.1fr] min-h-[50vh] max-h-[65vh] md:min-h-[220px] md:max-h-none relative"
      >
