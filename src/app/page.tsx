        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Link href="/shop/pattupavadai" className="group relative rounded-xl overflow-hidden min-h-[220px] flex items-center transition-all duration-[--t] ease-[--spring] hover:scale-[1.015] hover:shadow-s4">
            ...
            <div className="relative z-10 p-7 md:p-8">
              ...
              <p className="text-[0.85rem] text-white/90 mb-4 drop-shadow-sm">48 handcrafted designs starting ₹1,159</p>
          ...
          <Link href="/shop/pattufrock" className="group relative rounded-xl overflow-hidden min-h-[220px] flex items-center transition-all duration-[--t] ease-[--spring] hover:scale-[1.015] hover:shadow-s4">
            ...
            <div className="relative z-10 p-7 md:p-8">
              <div className="text-[0.68rem] font-bold tracking-[0.14em] uppercase text-white/80 mb-2">Girls · 0–7 Years</div>
              <h3 className="font-head text-[1.6rem] font-bold text-white leading-[1.2] mb-1.5 drop-shadow-sm">
                Pattufrock<br /><em className="italic text-gold-pale">Collection</em>
              </h3>
              <p className="text-[0.85rem] text-white/90 mb-4 drop-shadow-sm">36 festive designs starting ₹899</p>
              <div className="inline-flex items-center gap-1.5 bg-white/20 backdrop-blur-md border border-white/40 text-white text-[0.8rem] font-bold py-2 px-4.5 rounded-full transition-colors group-hover:bg-white/30">
                Explore <ChevronRight size={14} />
              </div>
            </div>
